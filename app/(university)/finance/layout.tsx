...
/**
 * Module gate for /finance and everything beneath it.
 *
 ...
 */
export default function FinanceSegmentLayout({ children }: { children: ReactNode }) {
  return <ModuleGate path="/finance">{children}</ModuleGate>;
}
