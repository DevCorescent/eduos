...
/**
 * Module gate for /certificates and everything beneath it.
 *
 ...
 */
export default function CertificatesSegmentLayout({ children }: { children: ReactNode }) {
  return <ModuleGate path="/certificates">{children}</ModuleGate>;
}
