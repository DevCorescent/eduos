...
/**
 * Module gate for /curriculum and everything beneath it.
 *
 ...
 */
export default function CurriculumSegmentLayout({ children }: { children: ReactNode }) {
  return <ModuleGate path="/curriculum">{children}</ModuleGate>;
}
