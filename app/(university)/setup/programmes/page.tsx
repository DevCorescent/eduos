...
export default async function ProgrammesPage({
   ...
   */
  const failureHeader = (
    <PageHeader title="Programmes" subtitle="Degrees, diplomas and certificates this institution awards." />
  );
  ...
  return (
    <>
      ...
      <ListToolbar
        search={<ListSearch
              unsupported={UNSUPPORTED_SEARCH} placeholder="Search programmes…" />}
        filters={
          <>
            <ListFilter
