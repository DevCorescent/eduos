...
/**
 * Module gate for /evaluation and everything beneath it.
 *
 ...
 */
export default function EvaluationSegmentLayout({ children }: { children: ReactNode }) {
  return <ModuleGate path="/evaluation">{children}</ModuleGate>;
}
