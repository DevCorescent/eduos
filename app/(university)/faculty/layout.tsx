...
/**
 * Module gate for /faculty and everything beneath it.
 *
 ...
 */
export default function FacultySegmentLayout({ children }: { children: ReactNode }) {
  return <ModuleGate path="/faculty">{children}</ModuleGate>;
}
