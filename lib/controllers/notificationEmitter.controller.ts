...
/**
 * Re-exported so a route imports its emitter and its post-commit wrapper from
 * one place. The implementation lives in the service because it decides policy
 * — what a failure means — and this module is the database adapter.
 */
export { notifyAfterCommit } from "@/lib/services/notificationEmitter.service";
